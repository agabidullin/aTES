...
func Init() *auth.Service {
	options := auth.Opts{
		...
		URL:               "http://localhost:8083",                     // base url of the protected service
	...
	service.AddCustomProvider("custom123", auth.Client{Cid: "cid1", Csecret: "csecret1"}, provider.CustomHandlerOpt{
